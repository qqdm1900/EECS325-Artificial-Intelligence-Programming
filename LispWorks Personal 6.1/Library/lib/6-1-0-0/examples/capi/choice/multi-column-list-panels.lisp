;; -*- Mode: Lisp; rcs-header: "$Header: /hope/lwhope1-cam/hope.0/compound/33/LISPcapi-examples/RCS/choice:multi-column-list-panels.lisp,v 1.3.2.1 2011/08/24 13:26:20 davef Exp $" -*-
...
;;; To make sorting by clicking on the header work, 
;;; The :TYPE here needs to match the :TITLE in the columns definitions
;;; in *multi-column-list-panel-test-columns* below. Because
;;; we are passing :selection-callback :sort in the header-args,
;;; clicking on the header invokes capi:SORTED-OBJECT-SORT-BY
;;; with the title of the column as the type. 
